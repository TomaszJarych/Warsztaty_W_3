...
public class EditGroup extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			request.setAttribute("group", groupService.loadGroupByID(id));
			getServletContext().getRequestDispatcher("/WEB-INF/views/adminViews/editGroup.jsp").forward(request, response);
